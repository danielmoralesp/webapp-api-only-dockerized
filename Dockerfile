...
ADD webapp-api-only-dockerized.conf /etc/nginx/sites-enabled/webapp-api-only-dockerized.conf
...
RUN mkdir /home/app/webapp-api-only-dockerized
COPY . /home/app/webapp-api-only-dockerized
RUN usermod -u 1000 app
RUN chown -R app:app /home/app/webapp-api-only-dockerized
WORKDIR /home/app/webapp-api-only-dockerized
